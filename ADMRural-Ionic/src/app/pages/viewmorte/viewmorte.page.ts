...
@Component({
  selector: 'app-viewmorte',
  templateUrl: './viewmorte.page.html',
  styleUrls: ['./viewmorte.page.scss'],
})
export class ViewmortePage implements OnInit {
  ...
  public imageFileBase64: any = "assets/imgs/imgdefaultnoedit.png";
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(() => {
      this.navCtrl.navigateRoot('/morte');
    })
  }
  goBack() {
    this.navCtrl.navigateRoot('/morte');
