...
@Component({
  selector: 'app-underviewtransfered',
  templateUrl: './underviewtransfered.page.html',
  styleUrls: ['./underviewtransfered.page.scss'],
})
export class UnderviewtransferedPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(() => {
      this.navCtrl.navigateRoot('/viewtransfered');
    })
  }
  ionViewWillEnter() { }
  ionViewWillLeave() { }
  ...
  MostraDados() {
    ...
    this.Authorizer.QueryStoreProc('Executar', 'spAnimal', params).then(res => {
      ...
      console.log("resultado edit data", resultado)
      try {
