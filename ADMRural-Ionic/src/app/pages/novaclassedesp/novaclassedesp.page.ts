...
@Component({
  selector: 'app-novaclassedesp',
  templateUrl: './novaclassedesp.page.html',
  styleUrls: ['./novaclassedesp.page.scss'],
})
export class NovaclassedespPage implements OnInit {
  ...
  goBack1() {
    this.navCtrl.navigateRoot('/novadespesa');
  }
...
/* ---------------------------------- SELECT DATA AND SEND TO novadespesa ----------------------------------------- */
  ...
  goBack() {
    this.router.navigate(['/novadespesa', this.ClasseDesp]);
  }
