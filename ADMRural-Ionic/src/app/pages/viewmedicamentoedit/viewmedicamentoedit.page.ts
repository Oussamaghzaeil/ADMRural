...
@Component({
  selector: 'app-viewmedicamentoedit',
  templateUrl: './viewmedicamentoedit.page.html',
  styleUrls: ['./viewmedicamentoedit.page.scss'],
})
export class ViewmedicamentoeditPage implements OnInit {
  Datainicio: Date;
  doses: number;
  Medicacao: string;
  repitir: number;
