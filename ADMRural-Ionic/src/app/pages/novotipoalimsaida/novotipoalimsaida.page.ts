...
@Component({
  selector: 'app-novotipoalimsaida',
  templateUrl: './novotipoalimsaida.page.html',
  styleUrls: ['./novotipoalimsaida.page.scss'],
})
export class NovotipoalimsaidaPage implements OnInit {
  ...
  ionViewDidLeave() {}
  goBack() {
    this.router.navigate(['/novaitemsaidaalim', this.TipoEntrada, this.tipoQty, this.unidade]);
  }
  goBack1() {
