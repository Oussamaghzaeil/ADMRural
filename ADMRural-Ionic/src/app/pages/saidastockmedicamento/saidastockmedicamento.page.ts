...
@Component({
  selector: 'app-saidastockmedicamento',
  templateUrl: './saidastockmedicamento.page.html',
  styleUrls: ['./saidastockmedicamento.page.scss'],
})
export class SaidastockmedicamentoPage implements OnInit {
