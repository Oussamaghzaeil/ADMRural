...
@Component({
  selector: 'app-mapamedicaodeareas',
  templateUrl: './mapamedicaodeareas.page.html',
  styleUrls: ['./mapamedicaodeareas.page.scss'],
})
export class MapamedicaodeareasPage implements OnInit {
  constructor(
  ...
  goBack() {
    ...
    this.router.navigate(['/novomedicaodearea', this.codigoMedicao]);
  }
  ...
  async CargarMapa() {
    ...
    var firstpolyline = new leaflet.Polygon(pointList, {
      color: 'red',
      weight: 2,
      opacity: 1.0,
      smoothFactor: 1
  ...
  getCordinadas() {
    ...
    let params = {
      'StatusCRUD': 'Pesquisar_Cordinadas',
      'formValues': '',
