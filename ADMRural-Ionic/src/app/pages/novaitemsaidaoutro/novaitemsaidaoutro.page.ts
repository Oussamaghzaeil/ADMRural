...
@Component({
  selector: 'app-novaitemsaidaoutro',
  templateUrl: './novaitemsaidaoutro.page.html',
  styleUrls: ['./novaitemsaidaoutro.page.scss'],
})
export class NovaitemsaidaoutroPage implements OnInit {
  ...
  ngOnInit() {
    this.activatedRoute.params.subscribe(
      data => {
        ...
        console.log("Unidade ==>", this.UnidadSelected);
  ...
  goInsertTipo() {
    this.navCtrl.navigateRoot('/novotipo-outrosaida');
  }
