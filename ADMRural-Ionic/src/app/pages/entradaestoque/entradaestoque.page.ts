...
@Component({
  selector: 'app-entradaestoque',
  templateUrl: './entradaestoque.page.html',
  styleUrls: ['./entradaestoque.page.scss'],
})
export class EntradaestoquePage implements OnInit {
  public a: any;
  constructor(
  ...
  goToo(CodigoFazenda) {
    ...
    this.navCtrl.navigateRoot('/tipoestoque', CodigoFazenda);
