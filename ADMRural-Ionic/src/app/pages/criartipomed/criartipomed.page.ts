...
@Component({
  selector: 'app-criartipomed',
  templateUrl: './criartipomed.page.html',
  styleUrls: ['./criartipomed.page.scss'],
})
export class CriartipomedPage implements OnInit {
  constructor(
