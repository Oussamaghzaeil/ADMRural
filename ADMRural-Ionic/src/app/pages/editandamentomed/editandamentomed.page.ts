...
@Component({
  selector: 'app-editandamentomed',
  templateUrl: './editandamentomed.page.html',
  styleUrls: ['./editandamentomed.page.scss'],
})
export class EditandamentomedPage implements OnInit {
  portForm: FormGroup;
  ...
  MostraDados() {
    ...
    //   i    =parseInt(atob(i)); 
    let params = {
      'StatusCRUD': 'Pesquisar_view_edit_med',
