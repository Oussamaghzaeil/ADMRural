...
@Component({
  selector: 'app-viewvendidoestoquesaida',
  templateUrl: './viewvendidoestoquesaida.page.html',
  styleUrls: ['./viewvendidoestoquesaida.page.scss'],
})
export class ViewvendidoestoquesaidaPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(() => {
      this.navCtrl.navigateRoot('/saidaestoqueanimaisvendidos');
    })
  }
  ionViewDidEnter() {
    this.MostraDados();
