...
@Component({
  selector: 'app-viewperdido',
  templateUrl: './viewperdido.page.html',
  styleUrls: ['./viewperdido.page.scss'],
})
export class ViewperdidoPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(() => {
      this.navCtrl.navigateRoot('/perdido');
    })
  }
  goBack() {
    this.navCtrl.navigateRoot('/perdido');
