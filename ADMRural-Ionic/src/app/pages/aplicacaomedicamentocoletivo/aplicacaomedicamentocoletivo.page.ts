...
@Component({
  selector: 'app-aplicacaomedicamentocoletivo',
  templateUrl: './aplicacaomedicamentocoletivo.page.html',
  styleUrls: ['./aplicacaomedicamentocoletivo.page.scss'],
})
export class AplicacaomedicamentocoletivoPage implements OnInit {
  ...
  MostraDados() {
    ...
    let params = {
      'StatusCRUD': 'Pesquisar_edit_aplicacao_coletivo',
  ...
  atualizar(form: NgForm) {
    ...
    let params = {
      'StatusCRUD': 'Gravar_Aplicacao_coletivo',
