...
@Component({
  selector: 'app-aplicacadomedicamento',
  templateUrl: './aplicacadomedicamento.page.html',
  styleUrls: ['./aplicacadomedicamento.page.scss'],
})
export class AplicacadomedicamentoPage implements OnInit {
  ...
  MostraDadosaplicacao() {
    ...
    console.log('vlue of CodigoTratamento :', atob(CodigoTratamento)); 
    let params = {
      'StatusCRUD': 'Pesquisar_aplicacao_aplicado',
      'formValues': CodigoAnimal,
      'CodigoTratamento' : atob(CodigoTratamento),
      'CodigoUsuarioSistema': JSON.parse(sessionStorage.getItem("SessionUser"))[0].CodigoUsuario,
      'Hashkey': sessionStorage.getItem("SessionHashkey"),
