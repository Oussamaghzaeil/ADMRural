...
@Component({
  selector: 'app-medicoesdeareas',
  templateUrl: './medicoesdeareas.page.html',
  styleUrls: ['./medicoesdeareas.page.scss'],
})
export class MedicoesdeareasPage implements OnInit {
  ...
  goToo(CodigoFazenda) {
    ...
    this.navCtrl.navigateRoot('/medicaodeareain', CodigoFazenda);
