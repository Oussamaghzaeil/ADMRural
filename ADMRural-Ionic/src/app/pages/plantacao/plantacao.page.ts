...
@Component({
  selector: 'app-plantacao',
  templateUrl: './plantacao.page.html',
  styleUrls: ['./plantacao.page.scss'],
})
export class PlantacaoPage implements OnInit {
  ...
  goToo(CodigoFazenda) {
    ...
    this.navCtrl.navigateRoot('/plantacaoandamento', CodigoFazenda);
