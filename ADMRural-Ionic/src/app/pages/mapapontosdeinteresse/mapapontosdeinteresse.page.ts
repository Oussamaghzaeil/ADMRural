...
@Component({
  selector: 'app-mapapontosdeinteresse',
  templateUrl: './mapapontosdeinteresse.page.html',
  styleUrls: ['./mapapontosdeinteresse.page.scss'],
})
export class MapapontosdeinteressePage implements OnInit {
  constructor(
  ...
  goBack() {
    ...
    this.router.navigate(['/novopontosdeinteresse', this.codigo]);
  }
