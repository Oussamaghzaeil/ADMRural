...
@Component({
  selector: 'app-novomedicamentocoletivo',
  templateUrl: './novomedicamentocoletivo.page.html',
  styleUrls: ['./novomedicamentocoletivo.page.scss'],
})
export class NovomedicamentocoletivoPage implements OnInit {
  ...
  ngOnInit() {
    this.CodigoTratamentoCol = sessionStorage.getItem('CodigoTratamento');
