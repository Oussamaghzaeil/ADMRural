...
@Component({
  selector: 'app-editfinalizadomed',
  templateUrl: './editfinalizadomed.page.html',
  styleUrls: ['./editfinalizadomed.page.scss'],
})
export class EditfinalizadomedPage implements OnInit {
  portForm: FormGroup;
  ...
  MostraDados() {
    ...
    let params = {
      'StatusCRUD': 'Pesquisar_view_finalizado_med',
