...
@Component({
  selector: 'app-editfinalizadoalim',
  templateUrl: './editfinalizadoalim.page.html',
  styleUrls: ['./editfinalizadoalim.page.scss'],
})
export class EditfinalizadoalimPage implements OnInit {
  portForm: FormGroup;
  ...
  MostraDados() {
    ...
    //   i    =parseInt(atob(i)); 
    let params = {
      'StatusCRUD': 'Pesquisar_view_finalizado_alim',
