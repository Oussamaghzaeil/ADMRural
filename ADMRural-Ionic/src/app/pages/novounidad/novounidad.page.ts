...
@Component({
  selector: 'app-novounidad',
  templateUrl: './novounidad.page.html',
  styleUrls: ['./novounidad.page.scss'],
})
export class NovounidadPage implements OnInit {
  constructor(
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(()=>{
      this.navCtrl.navigateRoot('/createunidade');
    })  
  }
  ionViewWillEnter() {}
  ionViewDidEnter() {
      ...
      this.Authorizer.QueryStoreProc('Executar', 'spEstoque', params).then(res => {
        ...
        try {
          ...
          if (resultado.success) {
            this.alertService.presentAlert({ pTitle: 'Salvando Unidad...', pSubtitle: '', pMessage: 'Operação realizada com sucesso!' });
