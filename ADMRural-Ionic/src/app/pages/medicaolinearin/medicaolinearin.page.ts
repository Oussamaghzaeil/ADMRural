...
@Component({
  selector: 'app-medicaolinearin',
  templateUrl: './medicaolinearin.page.html',
  styleUrls: ['./medicaolinearin.page.scss'],
})
export class MedicaolinearinPage implements OnInit {
  public Nome: String;
  public a: any;
  public id: number;
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(() => {
      this.navCtrl.navigateRoot('/medicaolinear');
    })
  }
  goBack() {
    this.navCtrl.navigateRoot('/medicaolinear');
  ...
  goToCreate() {
    this.navCtrl.navigateRoot('/novomedicaolinear');
  }
 
  goToEdit(Codigo) {
    console.log("Codigo item", Codigo);
    this.navCtrl.navigateRoot('/editmedicaolinear', Codigo);
  ...
  MostraDadosInfo() {
    ...
    let params = {
      'StatusCRUD': 'Pesquisar_Medicao_Linear',
  ...
  delete(id) {
    ...
    let params = {
      'StatusCRUD': 'Delete_Medicao_Linear',
