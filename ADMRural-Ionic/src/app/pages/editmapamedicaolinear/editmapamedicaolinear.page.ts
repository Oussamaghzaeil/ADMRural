...
@Component({
  selector: 'app-editmapamedicaolinear',
  templateUrl: './editmapamedicaolinear.page.html',
  styleUrls: ['./editmapamedicaolinear.page.scss'],
})
export class EditmapamedicaolinearPage implements OnInit {
  constructor(
  ...
  goBack() {
    this.navCtrl.navigateRoot('/editmedicaolinear');
  }
  async CargarMapa() {
    let colorMarket: any;
  ...
  getCordinadas() {
    let params = {
      'StatusCRUD': 'Pesquisar_Cordinadas_Linear_edit',
