...
@Component({
  selector: 'app-editmapamedicaodeareas',
  templateUrl: './editmapamedicaodeareas.page.html',
  styleUrls: ['./editmapamedicaodeareas.page.scss'],
})
export class EditmapamedicaodeareasPage implements OnInit {
  constructor(
  ...
  goBack() {
    this.navCtrl.navigateRoot('/editmedicaodearea');
  }
  async CargarMapa() {
    let colorMarket: any;
