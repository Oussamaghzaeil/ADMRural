...
@Component({
  selector: 'app-editandamentoplantacao',
  templateUrl: './editandamentoplantacao.page.html',
  styleUrls: ['./editandamentoplantacao.page.scss'],
})
export class EditandamentoplantacaoPage implements OnInit {
  ...
  MostraDados() {
    ...
    //   i    =parseInt(atob(i)); 
    let params = {
      'StatusCRUD': 'Pesquisar_view_edit_plantacao',
