...
@Component({
  selector: 'app-colheitain',
  templateUrl: './colheitain.page.html',
  styleUrls: ['./colheitain.page.scss'],
})
export class ColheitainPage implements OnInit {
  public Nome: String;
  ...
  ngOnInit() {
    ...
    this.platform.backButton.subscribe(() => {
      this.navCtrl.navigateRoot('/colheita');
    })
  }
  goBack() {
    this.navCtrl.navigateRoot('/colheita');
  ...
  goTo() {
    this.navCtrl.navigateRoot('/novocolheita');
  }

  goToEdit(id) {
    console.log("Codigo item", id);
    this.navCtrl.navigateRoot('/editcolheita', id);
