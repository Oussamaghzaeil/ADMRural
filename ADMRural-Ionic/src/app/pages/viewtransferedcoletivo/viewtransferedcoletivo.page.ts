...
@Component({
  selector: 'app-viewtransferedcoletivo',
  templateUrl: './viewtransferedcoletivo.page.html',
  styleUrls: ['./viewtransferedcoletivo.page.scss'],
})
export class ViewtransferedcoletivoPage implements OnInit {
